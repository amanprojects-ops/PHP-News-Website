        ...
        ?>
                <div class="recent-post">
                    <a class="post-img" href="single.php?id=<?php echo base64_encode($row['post_id']); ?>">
                        <img loading="lazy" src="./assets/postImage/<?php echo $row['post_img']; ?>" alt="<?php echo $row['title']; ?>" />
                    </a>
                    <div class="post-content">
                        <h5><a href="single.php?id=<?php echo base64_encode($row['post_id']); ?>"><?php echo $row['title']; ?></a></h5>
                        <span>
