    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="post-container">
          ...
          include "config.php";
          if (isset($_GET['aid'])) {
            $auth_id = mysqli_real_escape_string($conn, base64_decode($_GET['aid']));
          ...
          ?>
            <h2 class="page-heading text-uppercase">News By <?php echo $row1['username']; ?></h2>
            <?php
          ...
          <?php
            ...
            if (mysqli_num_rows($result1) > 0) {
              ...
              if ($page > 1) {
                echo '<li><a href="author.php?aid=' . base64_encode($auth_id) . '&page=' . ($page - 1) . '">Prev</a></li>';
              }
              for ($i = 1; $i <= $total_page; $i++) {
                ...
                echo '<li class="' . $active . '"><a href="author.php?aid=' . base64_encode($auth_id) . '&page=' . $i . '">' . $i . '</a></li>';
              }
              if ($total_page > $page) {
                echo '<li><a href="author.php?aid=' . base64_encode($auth_id) . '&page=' . ($page + 1) . '">Next</a></li>';
              }
